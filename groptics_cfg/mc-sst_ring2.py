# 'array' is the geometry distrubution of the telescopes: will be converted direcly in '__temp__.corsikaIO'
...
Ring 2 200.000
* TLLOC   2       0.0     200.0       0.0  5.6  0.0  0.0
* TLLOC   3  -173.205     100.0       0.0  5.6  0.0  0.0
* TLLOC   4  -173.205    -100.0       0.0  5.6  0.0  0.0
* TLLOC   5      -0.0    -200.0       0.0  5.6  0.0  0.0
* TLLOC   6   173.205    -100.0       0.0  5.6  0.0  0.0
* TLLOC   7   173.205     100.0       0.0  5.6  0.0  0.0
"""

# 'arraystruct' is a list of telescope factories (it index+1 will be the standard number!) used to create
# '__temp__.arraytel' and '__temp__.mirrors'. Each factory is a tuple
...
# 'mirrors' is a tuple to build '__temp__.mirrors':
...
# 'reflectivity' is a tuple to build '__temp__.mirrors': (<help reflectivity>, <reflectivities>). 
...
# 'arraytel_format' is the tuple to build '__temp__'.arraytel: (<help>,<format>)
...
if __name__=='__main__':
    ...
    # 'telescopes' is a useful list to create '__temp__.arraytel' and '__temp__.mirrors'
